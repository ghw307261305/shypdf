  ...
  'ocr-pdf': {
    ...
    sections: [
      ...
      { h: 'Cómo obtener buenos resultados', p: [
        'Elige el idioma en el que está escrito el documento: es el factor que más influye en la precisión. Están disponibles inglés, español, portugués, francés, alemán, italiano, japonés, chino simplificado y chino tradicional, y «Reconocer también inglés» ayuda con los documentos que mezclan términos en inglés con otro idioma.',
