  ...
  'ocr-pdf': {
    ...
    sections: [
      ...
      { h: 'Como obter bons resultados', p: [
        'Escolha o idioma em que o documento está escrito — é o fator que mais pesa na precisão. Estão disponíveis inglês, espanhol, português, francês, alemão, italiano, japonês, chinês simplificado e chinês tradicional, e “Reconhecer também inglês” ajuda em documentos que misturam termos em inglês com outro idioma.',
