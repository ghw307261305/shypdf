...
const en = {
  ...
  tools: {
    ...
    'organize-pdf': {
      ...
      description: `Preview every page, drag thumbnails into a new order, rotate pages one at a time or all at once, and delete the ones you don’t need. ${LOCAL}`,
      button: 'Save PDF',
      steps: ['Choose a PDF. Its pages appear as thumbnails.', 'Drag thumbnails to reorder them; click ↻ to rotate a page (or “Rotate all”) and × to delete one.', 'Click “Save PDF” and download the result.'],
      faq: [PRIVACY_FAQ,
    ...
    'crop-pdf': {
      name: 'Crop PDF', short: 'Trim margins or select an area',
      description: `Crop the pages of a PDF: drag a box over the area to keep and trim everything outside it. ${LOCAL}`,
      button: 'Crop PDF',
      steps: ['Choose a PDF.', 'Drag the crop box over the area you want to keep; apply it to all pages or just the current one.', 'Click “Crop PDF” and download the result.'],
      faq: [PRIVACY_FAQ,
        { q: 'Is the cropped content deleted?', a: 'No — cropping changes which area of the page is displayed, but the full page stays inside the file and other tools can restore it. To permanently hide something confidential, cover it with a black box in Edit PDF instead.' },
        { q: 'Can I crop each page differently?', a: 'Choose “This page only”, crop it, then run the tool again for the next page. “All pages” applies the same box everywhere, which suits scanned books and slide handouts.' }],
    },
    'delete-pages': {
      name: 'Delete PDF pages', short: 'Remove pages you don’t need',
      description: `Delete pages from a PDF: click the pages to remove, or type their numbers, and save the rest as a new file. ${LOCAL}`,
      button: 'Delete pages',
      steps: ['Choose a PDF. Its pages appear as thumbnails.', 'Click × on every page you want to remove — or type page numbers such as 2, 5-7.', 'Click “Delete pages” and download the shorter PDF.'],
      faq: [PRIVACY_FAQ,
        { q: 'Is my original file changed?', a: 'No. You download a new PDF without the deleted pages; the file on your disk stays as it was.' },
        { q: 'What is the difference from Organize PDF?', a: 'Organize PDF also reorders and rotates pages. If all you need is to drop a few pages, this tool is the shorter path.' }],
    },
    'extract-pages': {
      name: 'Extract PDF pages', short: 'Pull pages into a new PDF',
      description: `Extract selected pages from a PDF into one new document — type ranges such as 1-3, 5 and download the result. ${LOCAL}`,
      button: 'Extract pages',
      steps: ['Choose a PDF.', 'Type the pages to extract, e.g. 1-3, 5, 8-10.', 'Click “Extract pages” — the selected pages become one new PDF.'],
      faq: [PRIVACY_FAQ,
        { q: 'How is this different from Split PDF?', a: 'Extract combines everything you select into a single new PDF. Split turns each range into its own separate file. To send pages 2 and 7 as one attachment, use Extract; to break a file into parts, use Split.' },
        { q: 'Can I repeat or reorder pages?', a: 'Pages come out in the order they appear in the document, once each. To reorder them, run the result through Organize PDF.' }],
    },
    'edit-pdf': {
      name: 'Edit PDF', short: 'Add text, highlights, white-out',
      description: `Edit a PDF in your browser: add text anywhere, highlight passages, or cover content with white or black boxes. ${LOCAL}`,
      button: 'Save PDF',
      steps: ['Choose a PDF.', 'Add text boxes, highlights or cover-up boxes, and drag them into place on the page.', 'Click “Save PDF” and download the edited copy.'],
      faq: [PRIVACY_FAQ,
        { q: 'Can I change the text that is already in the PDF?', a: 'Not directly — a PDF stores drawn characters, not editable paragraphs. You can cover the old text with a white box and type the correction over it. To rewrite a document properly, convert it with PDF to Word, edit it there, and convert back.' },
        { q: 'Is a black box a safe way to redact?', a: 'It hides the content in every viewer, and because ShyPDF draws it into the page image the underlying text is also removed from text selection on that area. Still, for legally sensitive redaction, delete the text at the source before making the PDF.' }],
    },
    'fill-pdf': {
      name: 'Fill PDF form', short: 'Type into form fields',
      description: `Fill in a PDF form on your device: text fields, checkboxes, radio buttons and dropdowns, with an option to flatten the result. ${LOCAL}`,
      button: 'Fill form',
      steps: ['Choose a PDF that has form fields.', 'Type your answers — the preview shows the filled form as you go.', 'Click “Fill form” and download the completed PDF.'],
      faq: [PRIVACY_FAQ,
        { q: 'The fields don’t react when I click the page. Why?', a: 'Your PDF probably has no real form fields — it is a printed form that only looks fillable. Use Edit PDF to type over it instead.' },
        { q: 'What does “flatten” do?', a: 'It converts your answers into fixed page content, so they can no longer be edited or accidentally cleared, and they display identically in every PDF reader. Flatten before sending a form unless the recipient needs to edit it further.' }],
    },
    'png-to-pdf': {
      name: 'PNG to PDF', short: 'Screenshots into one PDF',
      description: `Turn PNG images — screenshots, diagrams, scans — into a single PDF, one image per page. JPG and WebP work too. ${LOCAL}`,
      button: 'Convert to PDF',
      steps: ['Choose one or more PNG images.', 'Drag the cards into order and pick a page size (same as image, A4 or Letter).', 'Click “Convert to PDF” and download the result.'],
      faq: [PRIVACY_FAQ,
        { q: 'Is PNG transparency kept?', a: 'PDF pages are white, so transparent areas come out on a white background. Everything else — sharp text, line art, exact colors — is preserved; PNG is embedded without recompression unless you tick “Compress images”.' }],
    },
    'pdf-to-png': {
      name: 'PDF to PNG', short: 'Crisp images of each page',
      description: `Export each page of a PDF as a lossless PNG image at the resolution you choose. ${LOCAL}`,
      button: 'Convert to images',
      steps: ['Choose a PDF.', 'PNG is pre-selected — just pick the resolution.', 'Click “Convert to images”. Multiple pages download together as a zip.'],
      faq: [PRIVACY_FAQ,
        { q: 'PNG or JPG — which should I pick?', a: 'PNG is lossless: text stays razor sharp and diagrams keep clean edges, at the cost of larger files. JPG is smaller and fine for photo-heavy pages. For slides, invoices and anything with text, PNG usually looks better.' }],
    },
    'pdf-to-text': {
      name: 'PDF to Text', short: 'Plain .txt from a PDF',
      description: `Extract all the text from a PDF into a plain .txt file you can search, edit or feed to other tools. ${LOCAL}`,
      button: 'Extract text',
      steps: ['Choose a PDF that contains selectable text.', 'Optionally limit the pages and choose whether to mark page breaks.', 'Click “Extract text” and download the .txt file.'],
      faq: [PRIVACY_FAQ,
        { q: 'The output is empty or garbled. Why?', a: 'If it is empty, your PDF is probably a scan — run it through OCR PDF, which can output plain text directly. Garbled characters usually mean the PDF uses unusual font encodings; OCR PDF can often rescue those too, by reading the page image instead.' },
        { q: 'Does it keep the layout?', a: 'Line breaks are kept and pages are separated, but columns, tables and formatting are not — plain text has none. If you need the structure, use PDF to Word.' }],
    },
    'repair-pdf': {
      name: 'Repair PDF', short: 'Fix files that won’t open',
      description: `Try to repair a damaged PDF that won’t open or renders with errors, by rebuilding its internal structure. ${LOCAL}`,
      button: 'Repair PDF',
      steps: ['Choose the damaged PDF.', 'There is nothing to configure.', 'Click “Repair PDF”. If the file can be rebuilt, the repaired copy downloads.'],
      faq: [PRIVACY_FAQ,
        { q: 'What kinds of damage can be fixed?', a: 'A truncated download, a broken cross-reference table, or structural errors left by a buggy generator can often be repaired, because the page data itself is still in the file. If the actual page content is missing or overwritten, no tool can bring it back.' },
        { q: 'The tool says my file can’t be repaired. What now?', a: 'Try re-downloading or re-exporting the file from wherever it came from — most “corrupt” PDFs are incomplete copies, and a fresh copy fixes that.' }],
    },
  },
  ...
  client: {
    ...
    'crop-pdf.applyTo': 'Apply to',
    'crop-pdf.all': 'All pages',
    'crop-pdf.current': 'This page only',
    'crop-pdf.boxLabel': 'Crop area',
    'crop-pdf.hint': 'Drag the box to move it; drag the round handle to resize it. Everything outside the box is trimmed.',
    'crop-pdf.prevPage': 'Previous page',
    'crop-pdf.nextPage': 'Next page',
    'crop-pdf.pageOf': 'Page {i} of {n}',
    'crop-pdf.cropping': 'Cropping…',

    'delete-pages.hint': 'Click × on every page you want to remove. The remaining pages become the new PDF.',
    'delete-pages.ranges': 'Or type the pages to delete',
    'delete-pages.rangesPlaceholder': 'e.g. 2, 5-7',
    'delete-pages.keepOne': 'At least one page must remain.',
    'delete-pages.rebuilding': 'Rebuilding file…',

    'extract-pages.ranges': 'Pages to extract',
    'extract-pages.rangesPlaceholder': 'e.g. 1-3, 5, 8-10',
    'extract-pages.hint': 'The selected pages are combined, in document order, into one new PDF.',
    'extract-pages.extracting': 'Extracting pages…',

    'edit-pdf.add': 'Add to the page',
    'edit-pdf.text': 'Text',
    'edit-pdf.highlight': 'Highlight',
    'edit-pdf.whiteout': 'White-out',
    'edit-pdf.blackout': 'Black box',
    'edit-pdf.textPlaceholder': 'Type here',
    'edit-pdf.textColor': 'Text color',
    'edit-pdf.black': 'Black',
    'edit-pdf.red': 'Red',
    'edit-pdf.blue': 'Blue',
    'edit-pdf.hint': 'Click a button, then click the page to place it. Drag to move, drag the round handle to resize, × removes it.',
    'edit-pdf.remove': 'Remove',
    'edit-pdf.prevPage': 'Previous page',
    'edit-pdf.nextPage': 'Next page',
    'edit-pdf.pageOf': 'Page {i} of {n}',
    'edit-pdf.nothing': 'Add at least one change before saving.',
    'edit-pdf.applying': 'Applying changes to page {i} of {n}',

    'fill-pdf.fields': 'Form fields',
    'fill-pdf.field': 'Field {n}',
    'fill-pdf.choose': '— choose —',
    'fill-pdf.flatten': 'Flatten the form (answers become fixed text and can no longer be edited)',
    'fill-pdf.hint': 'Fields are listed in the order they appear in the document. The preview shows the current page.',
    'fill-pdf.noFields': 'This PDF has no fillable form fields — it is probably a printed form that only looks fillable. Use Edit PDF to type over it, or Sign PDF for signatures.',
    'fill-pdf.prevPage': 'Previous page',
    'fill-pdf.nextPage': 'Next page',
    'fill-pdf.pageOf': 'Page {i} of {n}',
    'fill-pdf.filling': 'Filling in the form…',

    'pdf-to-text.pages': 'Pages (leave empty for all)',
    'pdf-to-text.pagesPlaceholder': 'e.g. 1-3, 5',
    'pdf-to-text.breaks': 'Mark page breaks',
    // 会写进输出的 .txt 里，{n} 为页码
    'pdf-to-text.breakLine': '----- Page {n} -----',
    'pdf-to-text.reading': 'Reading page {i} of {n}',
    'pdf-to-text.noText': 'This PDF has no selectable text — it is probably a scan. Run it through OCR PDF and choose “Plain text” there instead.',

    'repair-pdf.hint': 'The file is rebuilt by qpdf: cross-reference tables and object structure are written fresh, recovering what can be recovered.',
    'repair-pdf.repairing': 'Rebuilding file…',
    'repair-pdf.encrypted': 'This PDF is password-protected. Remove the password with Unlock PDF first, then repair it.',
    'repair-pdf.failed': 'This file is damaged beyond repair. Try downloading or exporting it again from the original source.',
  },
};
